...
// GET → valida el token antes de mostrar la página
...
// POST → dueña aprueba → genera token de reset → manda correo al admin
export async function POST(req) {
  try {
    ...
    console.log("🔗 Link de reset enviado a:", admin.email, "→", resetLink);
