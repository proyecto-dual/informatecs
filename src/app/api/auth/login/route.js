...
//   }
// }
// src/app/api/auth/adminLogin/route.js
// src/app/api/auth/adminLogin/route.js
import { NextResponse } from "next/server";
import { prisma } from "@/lib/prisma";
import bcrypt from "bcryptjs";

// Contraseñas originales como fallback si no hay en BD
const HARDCODED = {
...
export async function POST(req) {
  ...
  try {
    // 1. Buscar contraseña actualizada en BD
    ...
    // 2. Fallback a contraseña hardcodeada original
