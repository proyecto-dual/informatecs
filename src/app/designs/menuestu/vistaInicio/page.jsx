...
export default function WelcomePage() {
  ...
  const albatrosData = [
    { id: 1, name: "Albatro Ajedrez", image: "/imagenes/albatroajedrez.png" },
    { id: 2, name: "Albatro Catrín", image: "/imagenes/albatrocatrin.png" },
    { id: 3, name: "Albatro Aventurero", image: "/imagenes/albatroreally.png" },
    { id: 4, name: "Albatro Basquet", image: "/imagenes/basquet.png" },
    { id: 5, name: "Albatro Banda", image: "/imagenes/albatrobanda.png" },
    { id: 6, name: "Albatro Aventurero", image: "/imagenes/logoevento.png" },
  ];
        ...
        <div className={`welcome-hero ${isVisible ? "visible" : ""}`}>
          <div className="albatros-showcase">
            <div className="main-albatros-container">
              {albatrosData.map((albatros, index) => (
                <div
                  key={albatros.id}
                  className={`albatros-slide ${index === activeAlbatros ? "active" : ""}`}
                >
                  <img
                    src={albatros.image}
                    alt={albatros.name}
            ...
            <div className="albatros-indicators">
              {albatrosData.map((albatros, index) => (
                <button
                  ...
                  className={`indicator-btn ${index === activeAlbatros ? "active" : ""}`}
          ...
          <div className="welcome-content-enhanced">
            ...
            <p className="welcome-description">
              Antes de lanzarte a las actividades, dale un vistazo rápido a tu
              perfil para confirmar que tus datos estén al día...
            </p>

            {/* 2. Grid de beneficios ahora con Enlaces funcionales */}
            <div className="benefits-grid">
              {/* Tarjeta Perfil */}
              <Link href="/designs/menuestu" className="benefit-card-link">
              ...
              >
                <div className="benefit-card">
                  ...
                  <h3>Actividades</h3>
                  <p>
                    Descubre e inscríbete en eventos adaptados a tus intereses
                  </p>
                </div>
              </Link>
